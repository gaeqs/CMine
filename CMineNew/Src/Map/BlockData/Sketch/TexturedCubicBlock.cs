...
namespace CMineNew.Map.BlockData.Sketch{
    public class TexturedCubicBlock : CubicBlock{
        ...
        public TexturedCubicBlock(BlockStaticDataTexturedCubic staticData, Chunk chunk, Vector3i position, Color4 textureFilter)
        ...
        public override Block Clone(Chunk chunk, Vector3i position) {
            return new TexturedCubicBlock((BlockStaticDataTexturedCubic) _staticData, _chunk, _position, _textureFilter);
        }
